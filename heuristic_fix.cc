...
RecVec ph(int32_t, const RecList&, Order);
...
RecVec ph(int32_t width, const RecList& rectangles, Order order) {
    ...
    auto sortedIndices = sort_indexes<RecTuple, RecLess<0>>(remain);
